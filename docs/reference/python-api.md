...
preflight validation (see [Optical Data Validation & Preflight](../core-features/optical-validation.md)),
...
[Security Model](security.md)). Overrides matching env vars for the process.
...
[Pipelines & Batch Processing](pipelines.md)'s "Python Processing Pipeline" section for
