...
# Load coregister.py directly (bypassing pygeofetch/__init__.py and
# pygeofetch/insar/__init__.py, which pull in unrelated package deps
# like pydantic that aren't needed to exercise this module).
_spec = importlib.util.spec_from_file_location(
    "coregister", "/home/mrtenkorang/open-source-projects/pygeofetch/pygeofetch/insar/coregister.py"
)
import sys
coregister = importlib.util.module_from_spec(_spec)
sys.modules["coregister"] = coregister
_spec.loader.exec_module(coregister)
