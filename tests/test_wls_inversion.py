...
"""
import sys
# sys.path.insert(0, "/home/mrtenkorang/open-source-projects/insar_check_new")
...
ts_mod = _load("pygeofetch.insar.timeseries", "pygeofetch/insar/timeseries.py")
validate_mod = _load("pygeofetch.insar.validate", "pygeofetch/insar/validate.py")
