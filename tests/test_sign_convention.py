...
import sys
# sys.path.insert(0, "/home/mrtenkorang/open-source-projects/sign_convention_test")
...
geo = _load("pygeofetch.insar.geolocation", "pygeofetch/insar/geolocation.py")
offgeo = _load("pygeofetch.insar.offset_geometry", "pygeofetch/insar/offset_geometry.py")
annot = _load("pygeofetch.insar.annotation", "pygeofetch/insar/annotation.py")
