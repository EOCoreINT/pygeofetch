...
"""
import sys
sys.path.insert(0, "/home/mrtenkorang/open-source-projects/pygeofetch/pygeofetch")

import importlib.util

spec = importlib.util.spec_from_file_location(
    "timeseries", "/home/mrtenkorang/open-source-projects/pygeofetch/pygeofetch/insar/timeseries.py"
)
timeseries = importlib.util.module_from_spec(spec)
import sys as _sys
_sys.modules["timeseries"] = timeseries
spec.loader.exec_module(timeseries)

PairCandidate = timeseries.PairCandidate
build_sbas_network = timeseries.build_sbas_network
